...
info.cell(row=2, column=1).value = "This file contains the templates for the different substance classes. Please fill in the information for each substance in the corresponding sheet."
...
info.cell(row=12, column=1).value = "Each substance should have it's own datasheet"

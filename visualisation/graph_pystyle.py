...
with dot.subgraph(name='cluster_0') as c:
    c.attr(color='black', fontname='Cabin-Medium', fontpath='../utils/Cabin_Medium.ttf', margin='2', padding='4', rankdir='TB', style='rounded', fontsize='20', label='<Substances>')
    c.node('Substance', color='#2a58adc3', fontcolor='white', height='1.0', shape='ellipse', style='filled', width='2.0', fontsize='18')
...
dot.edge('Element', 'Substance', color='blue')
dot.edge('Compound', 'Substance', color='blue')
dot.edge('Material', 'Substance', color='blue')
dot.edge('Component', 'Substance', color='blue')
dot.edge('Product', 'Substance', color='blue')

from visualisation.create_process_flow_diagram import create_process_flow_diagram
...
class Model:
    ...
    def list_substances(self):
        substance_names = list(self.elements.keys()) + list(self.compounds.keys()) + list(self.materials.keys()) + list(self.components.keys()) + list(self.products.keys())
